        ...
        <form method="post" method="<?php echo $_SERVER['PHP_SELF'];?>">
            <div class="row">
                <div class="col-md-5 col-md-offset-3">
                    ...
                    <section id="form">Not yet a Member? <a href="studentregister.php">Sign Up </a></section> 
                </div>
            </div>
    <?php
// Create connection
...
echo "<script language= 'javascript' type='text/javascript'> location.href= 'studenthome.php' </script>";
}
 else {
    ...
    <footer>
        <div class="row">
            <div class="col-md-3 col-md-offset-6" id="footer">
                <p class="text-center" name="top"><img src="login/img/fb.png"><img src="login/img/twit.png"><img src="login/img/youtube.png"><img src="login/img/linked.png"></p>
                <p class="text-center"><img src="login/img/nsc_footer_logo.png" width="210"> </p>
                <p class="text-center"><a href="contact.php"></a>Contact Us</p>
