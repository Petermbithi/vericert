    ...
    <header>
        <div class="container" id="topcontainer"><img src="login/img/headerlogo2.PNG" height="90">
            <ul class="nav nav-pills">
                <li><a class="text-success bg-success" href="ulogin.com">Verify Now</a></li>
        ...
        <form method="post" method="<?php echo $_SERVER['PHP_SELF'];?>">
            <div class="row">
                <div class="col-md-5 col-md-offset-3">
                    ...
                    <section id="form">Not yet a Member? <a href="registerinsitutiton.php">Sign Up </a></section>
                </div>
            </div>
            <?php
// Create connection
...
$query ="SELECT * FROM institutions WHERE username='$username' AND Password='$password'";
$result = mysqli_query($db, $query);
if(mysqli_num_rows($result)==1){
$_SESSION['username'] = $username;
echo "<script language= 'javascript' type='text/javascript'> location.href= 'institutionupdate.php' </script>";
}
 else {
    ...
    <footer>
        <div class="row">
            <div class="col-md-3 col-md-offset-6" id="footer">
                <p class="text-center"><a href="contact.php">Contact Us</a></p>
